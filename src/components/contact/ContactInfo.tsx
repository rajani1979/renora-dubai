  ...
  return (
    <div className="space-y-10">
      ...
      <a
        ...
        className="flex items-center gap-4 bg-[#25D366]/10 border border-[#25D366]/30 hover:border-[#25D366] p-6 transition-all duration-200 group"
      >
        ...
        <div>
          <p className="font-inter font-semibold text-renora-black group-hover:text-[#25D366] transition-colors duration-200">
            Chat on WhatsApp
          </p>
          <p className="text-renora-gray font-inter text-sm">
            Fastest way to reach us — usually reply within hours
          </p>
        </div>
        <MessageCircle
          size={20}
          className="text-[#25D366] ml-auto shrink-0 opacity-0 group-hover:opacity-100 transition-opacity"
        />
      </a>
        ...
        {details.map((d) => {
          ...
          return (
            <div key={d.label} className="flex items-start gap-4">
              <div className="w-10 h-10 bg-renora-cream flex items-center justify-center shrink-0">
      ...
      {/* Payment reminder */}
      <div className="bg-renora-cream border-l-4 border-renora-gold p-6">
        <p className="font-playfair font-bold text-renora-black text-sm mb-2">
          Before You Enquire
        </p>
        <ul className="space-y-1.5">
          {[
            ...
            <li
              key={item}
              className="text-renora-gray font-inter text-xs flex items-center gap-2"
            >
